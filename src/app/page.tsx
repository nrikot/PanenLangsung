...
const features = [
  {
    ...
    title: 'Automated RFQ',
    description:
      'Sistem permintaan penawaran otomatis yang menghubungkan pembeli dengan ratusan petani secara real-time.',
  },
  {
    icon: BadgeCheck,
    title: 'Verifikasi Level',
    description:
      'Tiga tingkat verifikasi berbasis dokumen resmi untuk menjamin kepercayaan setiap transaksi.',
  },
  {
    icon: Fingerprint,
    title: 'Unique Verification',
    description:
      'Setiap akun terikat dengan identitas unik — menghindari duplikasi dan kecurangan.',
  },
  {
    icon: Shield,
    title: 'Pembayaran Escrow',
    description:
      'Dana pembeli terkunci aman dan hanya dilepas ke petani setelah konfirmasi penerimaan barang.',
  },
  {
    icon: Coins,
    title: 'Lelang Hasil Panen',
    description:
      'Petani bisa membuka lelang untuk hasil panen, mendapatkan harga pasar terbaik secara kompetitif.',
  },
  {
    icon: MapPin,
    title: 'Pencarian Lokal GPS',
    description:
      'Temukan produk dan petani terdekat berdasarkan koordinat GPS untuk logistik yang lebih efisien.',
  },
];
...
const puzzleCards = [
  {
    icon: Leaf,
    title: '100% Organik',
    desc: 'Hasil panen segar langsung dari kebun',
    visual: 'cell' as const,
  },
  {
    icon: Shield,
    title: 'Escrow Aman',
    desc: 'Dana terlindungi sampai barang diterima',
    visual: 'vault' as const,
  },
  {
    icon: Coins,
    title: 'Harga Terbaik',
    desc: 'Tanpa markup perantara',
    visual: 'sparkline' as const,
  },
  {
    icon: MapPin,
    title: 'Lokasi Terdekat',
    desc: 'Berbasis GPS, temukan petani sekitar',
        ...
        <div className='relative mx-auto max-w-7xl px-5 py-14 sm:px-6 sm:py-20 lg:py-28'>
          <div className='grid items-center gap-10 sm:gap-12 lg:grid-cols-2 lg:gap-16'>
            ...
            <div>
              ...
              >
                Platform B2B yang menghubungkan petani dan kelompok tani
                langsung dengan pembeli grosir - tanpa perantara, transparan dan
                terpercaya.
              </p>
      ...
      >
        <div className='relative  text-black dark:text-white mx-auto max-w-4xl px-5 py-16 text-center sm:px-6 sm:py-24'>
          ...
          <p className='mb-8 text-sm sm:mb-10 sm:text-base'>
            Bergabung dengan ribuan petani dan pembeli yang sudah merasakan
            manfaatnya.
          </p>
