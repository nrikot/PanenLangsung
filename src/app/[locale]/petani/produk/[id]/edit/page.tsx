  ...
  return (
    <div className="min-h-screen dark:bg-[#0d1410] bg-slate-50">
      ...
      <main className="mx-auto max-w-2xl px-6 py-8">
        <Link href="/petani/produk" className="mb-4 inline-block text-sm dark:text-green-400 text-green-600 hover:underline">&larr; {t("backToProducts")}</Link>
        <h1 className="mb-6 text-2xl font-bold dark:text-gray-100 text-slate-900">{t("editProduct")}</h1>
        ...
        <div className="dark:bg-white/[0.03] dark:border-white/10 mb-6 rounded-xl border bg-white border-black/10 p-4 shadow-sm">
          <h3 className="mb-3 font-semibold dark:text-gray-100 text-slate-900">{t("productPhotos")}</h3>
        ...
        <form onSubmit={handleSubmit} className="dark:bg-white/[0.03] dark:border-white/10 space-y-4 rounded-xl border bg-white border-black/10 p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1 block text-sm font-medium dark:text-gray-300 text-slate-700">{t("price")} <span className="text-red-500">*</span></label>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="mb-1 block text-sm font-medium dark:text-gray-300 text-slate-700">{t("quantity")} <span className="text-red-500">*</span></label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select value={form.status} onChange={(e) => setForm({ ...form, status: e.target.value })}
                ...
                <option value="habis">{t("statusHabis")}</option>
