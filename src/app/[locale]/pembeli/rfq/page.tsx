...
export default function RfqPembeliPage() {
  ...
  async function createRfq(e: React.FormEvent) {
    ...
    try {
      ...
      setFormMsg(e instanceof Error ? e.message : t('createError'));
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    ...
    >
      <div className='mb-6'>
        ...
        >
          {showCreate ? t('closeForm') : `+ ${t('createRfq')}`}
        </button>
      </div>
          ...
          <form onSubmit={createRfq} className='space-y-4'>
            <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
              <div>
                ...
                >
                  <option value=''>{t('createForm.selectCommodity')}</option>
                  {commodities.map((c) => (
              ...
              <div>
                ...
                <input
                  ...
                  min='1'
                  step='any'
                  placeholder={t('createForm.quantityPlaceholder')}
                  value={form.quantity}
                  onChange={(e) =>
              ...
              <div>
                <label className='mb-1 block text-sm font-medium dark:text-gray-300 text-slate-700'>
                  {t('createForm.targetPrice')}
                </label>
                <input
                  type='number'
                  min='1'
                  placeholder={t('createForm.targetPricePlaceholder')}
              ...
              <div className='sm:col-span-2'>
                <label className='mb-1 block text-sm font-medium dark:text-gray-300 text-slate-700'>
                  {t('createForm.deliveryLocation')}
                </label>
                <input
                  required
                  minLength={5}
                  maxLength={500}
                  placeholder={t('createForm.deliveryLocationPlaceholder')}
