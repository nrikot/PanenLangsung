  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="rounded-xl border dark:bg-white/[0.03] dark:border-white/10 bg-white border-black/10 p-8 shadow-sm">
        <h1 className="mb-6 text-center text-2xl font-bold dark:text-gray-100 text-slate-900">{t("title")}</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium dark:text-gray-300 text-slate-700">{t("email")}</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-sm font-medium dark:text-gray-300 text-slate-700">{t("password")}</label>
            <input
        ...
        <p className="mt-6 text-center text-sm dark:text-[#8b9e93] text-slate-500">
          {t("noAccount")}{" "}
          <Link href="/daftar" className="font-semibold dark:text-green-400 text-green-600 hover:underline">{t("registerLink")}</Link>
        </p>
      </div>
    </div>
  );
